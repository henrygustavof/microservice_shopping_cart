...
VALUES ('cloth and shoes', 'cloth and shoes'),('computers', 'computers');


INSERT INTO product(name,picture_url, description,unit,currency,price,category_id) 
VALUES ('adidas black t-shirt', 'https://hfuentesstorage.blob.core.windows.net/images/adidas_black_tshirt.jpg','didas black t-shirt',10,840,10,1),
('adidas white t-shirt', 'https://hfuentesstorage.blob.core.windows.net/images/adidas_white_tshirt.jpg','adidas white t-shirt',10,840,15,1),
